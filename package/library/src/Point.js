...
class Point {
    static get offset() {
        return {
            x: Camera_1.Camera.position.x,
            y: Camera_1.Camera.position.y,
        };
    }
    _x;
    get x() {
    ...
    static getRandomPoint() {
        return new Point(Math.random() * (config_1.config.graphics.scaledResolution.width - 50) + 50, Math.random() * (config_1.config.graphics.scaledResolution.height - 50) + 50, true);
    }
    toJSON() {
