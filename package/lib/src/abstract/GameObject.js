...
export class GameObject {
    ...
    SEQUENCE_SCALE = (config.graphics.scaledResolution.height / config.graphics.targetResolution.height) * 2;
    ...
    tags = new Set();
    constructor(scene, point = new Point(0, 0), remoteController = null, gameObjectId = generateId()) {
